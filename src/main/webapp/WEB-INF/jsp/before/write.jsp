...
<script type="text/javascript">
	...
	function selectEmail(){
		...
		/*getElementById 获得ID值=id的所有属性和方法*/
...
<%--提交表单时，向Emailcontroller层write方法发送数据--%>
	<form:form action="email/write" method="post" modelAttribute="myemail" enctype="multipart/form-data">
		<table border=1 style="border-collapse: collapse">
			...
			<tr>
				<td>主题<span style="color: red; ">*</span></td>
				<td>
					<form:input path="title" cssStyle="width:500px"/>     <%--主题--%>
				</td>
			</tr>
			<tr>
				<td>附件</td>
				<td>
					...
					<form:hidden path="attachfilename"/>                <%--附件名--%>
					<form:hidden path="attachfile"/>                    <%--附件内容--%>
			...
			<tr>
				<td colspan="2">
					<form:textarea path="content" rows="20"  cols="90"/>  <%--正文内容--%>
				</td>
			</tr>
			<tr>
