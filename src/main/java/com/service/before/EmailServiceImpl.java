...
public class EmailServiceImpl implements EmailService{
	...
	/*写信*/ emailDao.writeEmail(myemail);//添加邮件，添加成功后，Email的ID自动回填到myemail对象中
	...
	/* 添加邮件记录*/		emailDao.writeEmailRecord(rt);
			}
	        ...
	        //邮件备选项
	/*查询用户邮件*/   List<Buser> bemailsoption = emailDao.selectBuserEmail();
